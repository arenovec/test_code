<?php
    ...
    namespace app\widgets\sweetAlerts;

    use app\widgets\sweetAlerts\assets\AnimateCssAsset;
    use app\widgets\sweetAlerts\assets\SweetAlert2Asset;
    use Yii;
    ...
    class SweetAlert extends Widget
    {
        ...
        public function initSwal($options = '', $callback = '')
        {
            ...
            if($this->initFunction) {
                $js = "function {$this->initFunction} () {swal({$options}).then({$callback}).catch(swal.noop);}";
            }else
